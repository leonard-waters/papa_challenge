defmodule PapaChallengeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(PapaChallengeWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(PapaChallengeWeb.Gettext, "errors", msg, opts)
    # end
